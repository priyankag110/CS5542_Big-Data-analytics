...
def read_NewsGroup_data(similarity):
    categories_3NG = ['comp.graphics', 'rec.sport.baseball', 'talk.politics.guns', 'sci.crypt', 'talk.religion.misc']
...
learning_rate = 0.0020  # ---------- The learning rate.
stop_learning = 1.05 # --------------------- The stop learning point.
